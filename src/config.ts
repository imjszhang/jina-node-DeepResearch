...
export const JINA_RERANK_BASE_URL = env.JINA_RERANK_BASE_URL || 'https://api.jina.ai/v1/rerank';
export const JINA_EMBEDDING_BASE_URL = env.JINA_EMBEDDING_BASE_URL || 'https://api.jina.ai/v1/embeddings';
export const JINA_RERANK_MODEL = env.JINA_RERANK_MODEL || 'jina-reranker-v2-base-multilingual';
export const JINA_EMBEDDING_MODEL = env.JINA_EMBEDDING_MODEL || 'jina-embeddings-v3';
